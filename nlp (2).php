...
$perfectkw = array('non-government','nonprofit','orphanage',
    ...
    'social work','social help','charitable trust','NGO','charity','social worker');

$helperkw = array('NPO','BINGO','BONGO','CBO','CSO','ENGO','GONGO','MONGO','IPO','GRO','GSCO','NPO','organization',
    'ruralareas','society','needy','equality','help','awareness','under-privilege','education','poor','poverty','slum','support',
	...
	'rural','women','children','save','uplift','encourage','medical camp');
...
nlp('hhh charitable orientation');
